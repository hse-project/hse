...
merr_t
get_uid(const char *str, void *dst, size_t dstsz)
{
    merr_t         err;
    u64            num;
    struct passwd *pw;
...
merr_t
show_uid(char *str, size_t strsz, const void *val, size_t unused)
{
    struct passwd *pw;
    size_t         n;
...
merr_t
get_gid(const char *str, void *dst, size_t dstsz)
{
    u64           num;
    char *        ep = NULL;
    struct group *gr;
...
merr_t
show_gid(char *str, size_t strsz, const void *val, size_t unused)
{
    struct group *gr;
    size_t        len;
 ...
 *      Fails with EINVAL if ill formatted or if the result is greater that 0777
 * @value: input
 * @val: output
 */
merr_t
get_mode(const char *str, void *dst, size_t dstsz)
{
    u64   num;
    char *ep = NULL;
...
merr_t
show_mode(char *str, size_t strsz, const void *val, size_t unused)
{
    size_t n;
    ...
    if (*(int *)val == -1)
        ...
        n = snprintf(str, strsz, "0%03o", *(const mode_t *)val);
