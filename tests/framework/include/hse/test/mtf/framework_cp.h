...
#define ___MTF_INNER_DEFINE_UTEST_CP4(                                                             \
    coll_name, test_name, pre_hook, post_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, \
    v3)                                                                                            \
    ___MTF_INNER_DEFINE_UTEST(coll_name, test_name, pre_hook, post_hook)                           \
    {                                                                                              \
                                                                                                   \
...
#define MTF_DEFINE_UTEST_CP4_POST(                                                              \
    ...
    ___MTF_INNER_DEFINE_UTEST_CP4(                                                              \
        coll_name, test_name, 0, post_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, \
        v3)
...
#define MTF_DEFINE_UTEST_CP4_PREPOST(                                                              \
    ...
    v3)                                                                                            \
    ___MTF_INNER_DEFINE_UTEST_CP4(                                                                 \
        coll_name, test_name, pre_hook, post_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3,  \
        vt3, v3)
...
#define MTF_DEFINE_UTEST_CP5(                                                                    \
    ...
    ___MTF_INNER_DEFINE_UTEST_CP5(                                                               \
        coll_name, test_name, 0, 0, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, st4, \
        vt4, v4)

#define MTF_DEFINE_UTEST_CP5_PRE(                                                                  \
    coll_name, test_name, pre_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, st4,   \
    vt4, v4)                                                                                       \
    ___MTF_INNER_DEFINE_UTEST_CP5(                                                                 \
        coll_name, test_name, pre_hook, 0, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, \
        st4, vt4, v4)
...
#define MTF_DEFINE_UTEST_CP5_POST(                                                                \
    coll_name, test_name, post_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, st4, \
    vt4, v4)                                                                                      \
    ___MTF_INNER_DEFINE_UTEST_CP5(                                                                \
        coll_name, test_name, 0, post_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3,   \
        v3, st4, vt4, v4)
...
#define ___MTF_INNER_DEFINE_UTEST_CP7(                                                             \
    coll_name, test_name, pre_hook, post_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, \
    v3, st4, vt4, v4, st5, vt5, v5, st6, vt6, v6)                                                  \
    ___MTF_INNER_DEFINE_UTEST(coll_name, test_name, pre_hook, post_hook)                           \
    {                                                                                              \
                                                                                                   \
        ___MTF_VALUE_DECLARE(0, vt0, v0)                                                           \
...
#define MTF_DEFINE_UTEST_CP7(                                                                    \
    coll_name, test_name, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, st4, vt4, v4,  \
    st5, vt5, v5, st6, vt6, v6)                                                                  \
    ___MTF_INNER_DEFINE_UTEST_CP7(                                                               \
        coll_name, test_name, 0, 0, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, st4, \
        vt4, v4, st5, vt5, v5, st6, vt6, v6)
...
#define MTF_DEFINE_UTEST_CP7_PRE(                                                                  \
    ...
    ___MTF_INNER_DEFINE_UTEST_CP7(                                                                 \
        coll_name, test_name, pre_hook, 0, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, \
        st4, vt4, v4, st5, vt5, v5, st6, vt6, v6)
...
#define MTF_DEFINE_UTEST_CP7_PREPOST(                                                              \
    ...
    ___MTF_INNER_DEFINE_UTEST_CP7(                                                                 \
        coll_name, test_name, pre_hook, post_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3,  \
        vt3, v3, st4, vt4, v4, st5, vt5, v5, st6, vt6, v6)
...
#define ___MTF_INNER_DEFINE_UTEST_CP8(                                                             \
    coll_name, test_name, pre_hook, post_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, \
    v3, st4, vt4, v4, st5, vt5, v5, st6, vt6, v6, st7, vt7, v7)                                    \
    ___MTF_INNER_DEFINE_UTEST(coll_name, test_name, pre_hook, post_hook)                           \
    {                                                                                              \
                                                                                                   \
        ___MTF_VALUE_DECLARE(0, vt0, v0)                                                           \
...
#define MTF_DEFINE_UTEST_CP8(                                                                    \
    coll_name, test_name, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, st4, vt4, v4,  \
    st5, vt5, v5, st6, vt6, v6, st7, vt7, v7)                                                    \
    ___MTF_INNER_DEFINE_UTEST_CP8(                                                               \
        coll_name, test_name, 0, 0, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, st4, \
        vt4, v4, st5, vt5, v5, st6, vt6, v6, st7, vt7, v7)
...
#define MTF_DEFINE_UTEST_CP8_PRE(                                                                  \
    ...
    ___MTF_INNER_DEFINE_UTEST_CP8(                                                                 \
        coll_name, test_name, pre_hook, 0, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, \
        st4, vt4, v4, st5, vt5, v5, st6, vt6, v6, st7, vt7, v7)
...
#define MTF_DEFINE_UTEST_CP8_PREPOST(                                                              \
    ...
    ___MTF_INNER_DEFINE_UTEST_CP8(                                                                 \
        coll_name, test_name, pre_hook, post_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3,  \
        vt3, v3, st4, vt4, v4, st5, vt5, v5, st6, vt6, v6, st7, vt7, v7)
...
#define ___MTF_INNER_DEFINE_UTEST_CP9(                                                             \
    coll_name, test_name, pre_hook, post_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, \
    v3, st4, vt4, v4, st5, vt5, v5, st6, vt6, v6, st7, vt7, v7, st8, vt8, v8)                      \
    ___MTF_INNER_DEFINE_UTEST(coll_name, test_name, pre_hook, post_hook)                           \
    {                                                                                              \
                                                                                                   \
        ___MTF_VALUE_DECLARE(0, vt0, v0)                                                           \
                        ...
                        for (index4 = 0; index4 < ___mtf_##v4##_length; ++index4) {                \
                            ...
                            for (index5 = 0; index5 < ___mtf_##v5##_length; ++index5) {            \
                                ...
                                for (index6 = 0; index6 < ___mtf_##v6##_length; ++index6) {        \
                                    ...
                                    for (index7 = 0; index7 < ___mtf_##v7##_length; ++index7) {    \
                                        v7 = ___mtf_##v7##_values[index7];                         \
                                        for (index8 = 0; index8 < ___mtf_##v8##_length; ++index8)  \
                                        {                                                          \
                                            v8 = ___mtf_##v8##_values[index8];

#define MTF_DEFINE_UTEST_CP9(                                                                    \
    coll_name, test_name, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, st4, vt4, v4,  \
    st5, vt5, v5, st6, vt6, v6, st7, vt7, v7, st8, vt8, v8)                                      \
    ___MTF_INNER_DEFINE_UTEST_CP9(                                                               \
        coll_name, test_name, 0, 0, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, st4, \
        vt4, v4, st5, vt5, v5, st6, vt6, v6, st7, vt7, v7, st8, vt8, v8)
...
#define MTF_DEFINE_UTEST_CP9_PRE(                                                                  \
    ...
    ___MTF_INNER_DEFINE_UTEST_CP9(                                                                 \
        coll_name, test_name, pre_hook, 0, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, \
        st4, vt4, v4, st5, vt5, v5, st6, vt6, v6, st7, vt7, v7, st8, vt8, v8)
...
#define MTF_DEFINE_UTEST_CP9_PREPOST(                                                              \
    ...
    ___MTF_INNER_DEFINE_UTEST_CP9(                                                                 \
        coll_name, test_name, pre_hook, post_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3,  \
        vt3, v3, st4, vt4, v4, st5, vt5, v5, st6, vt6, v6, st7, vt7, v7, st8, vt8, v8)
...
#define ___MTF_INNER_DEFINE_UTEST_CP10(                                                            \
    coll_name, test_name, pre_hook, post_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, \
    v3, st4, vt4, v4, st5, vt5, v5, st6, vt6, v6, st7, vt7, v7, st8, vt8, v8, st9, vt9, v9)        \
    ___MTF_INNER_DEFINE_UTEST(coll_name, test_name, pre_hook, post_hook)                           \
    {                                                                                              \
                                                                                                   \
        ___MTF_VALUE_DECLARE(0, vt0, v0)                                                           \
...
#define MTF_DEFINE_UTEST_CP10(                                                                   \
    coll_name, test_name, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, st4, vt4, v4,  \
    st5, vt5, v5, st6, vt6, v6, st7, vt7, v7, st8, vt8, v8, st9, vt9, v9)                        \
    ___MTF_INNER_DEFINE_UTEST_CP10(                                                              \
        coll_name, test_name, 0, 0, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, st4, \
        vt4, v4, st5, vt5, v5, st6, vt6, v6, st7, vt7, v7, st8, vt8, v8, st9, vt9, v9)
...
#define MTF_DEFINE_UTEST_CP10_PRE(                                                                 \
    ...
    ___MTF_INNER_DEFINE_UTEST_CP10(                                                                \
        coll_name, test_name, pre_hook, 0, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3, vt3, v3, \
        st4, vt4, v4, st5, vt5, v5, st6, vt6, v6, st7, vt7, v7, st8, vt8, v8, st9, vt9, v9)
...
#define MTF_DEFINE_UTEST_CP10_PREPOST(                                                             \
    ...
    ___MTF_INNER_DEFINE_UTEST_CP10(                                                                \
        coll_name, test_name, pre_hook, post_hook, st0, vt0, v0, st1, vt1, v1, st2, vt2, v2, st3,  \
        vt3, v3, st4, vt4, v4, st5, vt5, v5, st6, vt6, v6, st7, vt7, v7, st8, vt8, v8, st9, vt9,   \
        v9)
