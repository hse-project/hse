...
struct perfc_name kvdb_perfc_op[] = {
    ...
    NE(PERFC_RA_KVDBOP_KVDB_MAKE,       3, "kvdb_make rate",          "r_kvdb_make(/s)"),
    ...
    NE(PERFC_RA_KVDBOP_KVDB_GET_NAMES,  3, "kvdb_get_names rate",     "r_kvdb_get_names(/s)"),
    NE(PERFC_RA_KVDBOP_KVDB_FREE_NAMES, 3, "kvdb_free_names rate",    "r_kvdb_free_names(/s)"),
    ...
    NE(PERFC_RA_KVDBOP_KVDB_KVS_MAKE,   3, "kvdb_kvs_make rate",      "r_kvdb_kvs_make(/s)"),
