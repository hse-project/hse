...
static const struct param_spec pspecs[] = {
    ...
    {
        .ps_name = "storage.capacity.dio_disable",
        .ps_description = "disable direct-io for capacity mclass",
        .ps_flags = PARAM_FLAG_EXPERIMENTAL,
        .ps_type = PARAM_TYPE_BOOL,
        .ps_offset = offsetof(struct kvdb_rparams, dio_disable[HSE_MCLASS_CAPACITY]),
        .ps_size = PARAM_SZ(struct kvdb_rparams, dio_disable[HSE_MCLASS_CAPACITY]),
        .ps_convert = param_default_converter,
        .ps_validate = param_default_validator,
        .ps_stringify = param_default_stringify,
        .ps_jsonify = param_default_jsonify,
    ...
    {
        .ps_name = "storage.staging.dio_disable",
        .ps_description = "disable direct-io for staging mclass",
        .ps_flags = PARAM_FLAG_EXPERIMENTAL,
        .ps_type = PARAM_TYPE_BOOL,
        .ps_offset = offsetof(struct kvdb_rparams, dio_disable[HSE_MCLASS_STAGING]),
        .ps_size = PARAM_SZ(struct kvdb_rparams, dio_disable[HSE_MCLASS_STAGING]),
        .ps_convert = param_default_converter,
        .ps_validate = param_default_validator,
        .ps_stringify = param_default_stringify,
        .ps_jsonify = param_default_jsonify,
    ...
    {
        .ps_name = "storage.pmem.dio_disable",
        .ps_description = "disable direct-io for pmem mclass",
        .ps_flags = PARAM_FLAG_EXPERIMENTAL,
        .ps_type = PARAM_TYPE_BOOL,
        .ps_offset = offsetof(struct kvdb_rparams, dio_disable[HSE_MCLASS_PMEM]),
        .ps_size = PARAM_SZ(struct kvdb_rparams, dio_disable[HSE_MCLASS_PMEM]),
        .ps_convert = param_default_converter,
        .ps_validate = param_default_validator,
        .ps_stringify = param_default_stringify,
        .ps_jsonify = param_default_jsonify,
