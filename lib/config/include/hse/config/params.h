...
typedef bool
param_converter_t(const struct param_spec *, const cJSON *, void *);
typedef bool
param_validator_t(const struct param_spec *, const void *);
typedef bool
param_relation_validator_t(const struct param_spec *, const void *);
typedef void
param_default_builder_t(const struct param_spec *, void *);
typedef merr_t
param_stringify_t(const struct param_spec *, const void *, char *, size_t, size_t *);
typedef cJSON *
param_jsonify_t(const struct param_spec *, const void *);
...
struct param_spec {
    ...
    param_relation_validator_t *
        ps_validate_relations /* Validates relations after conversion, validation, and updating of all data */
        ;
...
void
params_from_defaults(void *params, size_t pspecs_sz, const struct param_spec *pspecs);
...
cJSON *
params_to_json(const void *params, size_t pspecs_sz, const struct param_spec *pspecs)
