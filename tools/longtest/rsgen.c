...
static u32
rsgen_jhash_final(u32 a, u32 b, u32 c)
{
    c ^= b;
    c -= rol32(b, 14);
    a ^= c;
...
static u8 *
rsgen_hidden_set(u8 *here, u32 nbytes, u64 x)
{
...
static u64
rsgen_hidden_get(u8 *here, u32 nbytes)
{
    u64 x = 0;
...
void
rsgen_str(struct rsgen *rs, u16 tid, u64 id, u64 iter, u8 tag, void *val, u32 *len)
{
    u32 hidden_len = 1;
...
void
rsgen_set_tid(struct rsgen *rs, void *buf, u16 tid)
{
...
u16
rsgen_decode(void *str, int len, u64 *keynum, u64 *iter, u8 *tag)
{
    /*
